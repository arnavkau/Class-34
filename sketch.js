...
function preload()
{
  ...
  //starScore = loadAnimation("g_star1.png")
...
function setup() 
{
  ...
  star = createSprite(200, 450)
  star.scale = 0.02
  star.addImage(starImg)

  star2 = createSprite(300, 100)
  star2.addImage(starImg)
  star2.scale = 0.02
  

  starScore = createSprite(50, 50)
  starScore.addAnimation('empty',emptyStar)
  starScore.addAnimation('oneStar', oneStar)
  starScore.addAnimation('twoStar',twoStar)
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   {
      starScore.changeAnimation('twoStar')
      star.visible = false
   }

   if(collide(fruit,star2,20)==true)
   {
      starScore.changeAnimation('oneStar')
      star2.visible = false
   }
}
